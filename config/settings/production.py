...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["dashboard.paulopanganiban.dev"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="oloproject <noreply@dashboard.paulopanganiban.dev>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[oloproject]"
)
